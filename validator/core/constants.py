...
INSTRUCT_AUGMENTATION_PROB = 0.8
...
GRPO_WORD_TRANSFORM_PROB = 0.65

# Text transform augmentation constants
TEXT_TRANSFORM_PROB = 0.6
WORD_TRANSFORMS_PROB = 0.8
CASE_MODIFICATIONS_PROB = 0.7
PUNCTUATION_REMOVAL_PROB = 0.5
REFERENCE_WORD_PLACEMENT_PROB = 0.4
TEXT_TRANSFORMS_PROB = 0.6
...
GRPO_KL_BATCH_SIZE = 16
GRPO_DEFAULT_NUM_GENERATIONS = 2
GRPO_KL_SEQUENCE_LENGTH = 4096
