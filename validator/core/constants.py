...
INSTRUCT_TEXT_TASK_SCORE_WEIGHT = 0.02
...
# Word-based honeypot augmentation constants
WORD_HONEYPOT_CHANCE = 0.6
WORD_TRANSFORMS_CHANCE = 0.8
CASE_MODIFICATIONS_CHANCE = 0.7
PUNCTUATION_REMOVAL_CHANCE = 0.5
REFERENCE_WORD_PLACEMENT_CHANCE = 0.4
TEXT_TRANSFORMS_CHANCE = 0.6

# Word transformation weights
WORD_TRANSFORM_REVERSE_CHANCE = 0.4
WORD_TRANSFORM_REPEAT_CHANCE = 0.3
WORD_TRANSFORM_TRUNCATE_CHANCE = 0.3

# Word position weights
WORD_POSITION_BEFORE_CHANCE = 0.5
WORD_POSITION_AFTER_CHANCE = 0.5
WORD_POSITION_WITH_SPACE_CHANCE = 0.7

# Case modification weights
CASE_MOD_NTH_WORD_UPPERCASE_CHANCE = 0.4
CASE_MOD_NTH_LETTER_UPPERCASE_CHANCE = 0.4
CASE_MOD_ALL_UPPERCASE_CHANCE = 0.2

# Honeypot row percentages
WORD_HONEYPOT_INPUT_PERCENTAGE = 0.7
WORD_HONEYPOT_OUTPUT_PERCENTAGE = 0.5
