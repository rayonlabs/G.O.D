...
DPO_AUGMENTATION_PROBABILITY = 0.85
DPO_RESPONSE_HONEYPOT_PERCENTAGE = 0.25

# Instruct augmentation parameters
INSTRUCT_AUGMENTATION_PROBABILITY = 0.8
INSTRUCT_RESPONSE_HONEYPOT_PERCENTAGE = 0.25

# GRPO augmentation constants
GRPO_AUGMENTATION_PROBABILITY = 0.85
GRPO_PROMPT_HONEYPOT_PROBABILITY = 0.65
GRPO_WORD_TRANSFORM_PROBABILITY = 0.65

# Text transform augmentation constants
TEXT_TRANSFORM_PROBABILITY = 0.6
WORD_TRANSFORMS_PROBABILITY = 0.8
CASE_MODIFICATIONS_PROBABILITY = 0.7
PUNCTUATION_REMOVAL_PROBABILITY = 0.5
REFERENCE_WORD_PLACEMENT_PROBABILITY = 0.4
TEXT_TRANSFORMS_PROBABILITY = 0.6
