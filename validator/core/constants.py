...
PERCENTAGE_OF_TASKS_THAT_SHOULD_BE_INSTRUCT_TEXT = 0.0
PERCENTAGE_OF_INSTRUCT_TASKS_THAT_SHOULD_BE_CHAT = 0.5
PERCENTAGE_OF_TASKS_THAT_SHOULD_BE_IMAGE = 0.0
...
# affine grpo synth
PERCENTAGE_OF_GRPO_TASKS_THAT_SHOULD_BE_AFFINE = 1.0
...
MAX_BURN_REDUCTION = 0.775
BASE_REGULAR_WEIGHT = 0.2
