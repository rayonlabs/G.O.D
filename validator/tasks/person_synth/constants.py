...
PERSON_PROMPT = f"""
        Here is an image of a person named 'person_name'. Generate {NUM_PROMPTS} different prompts for creating an avatar of the person - make sure there name is listed in the prompt.
